package com.zs.appexecutionandenvironment.defaultproperties;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            try(FileInputStream inputStream = new FileInputStream("C:\\Users\\Zach\\IdeaProjects\\JavaCorePlatform\\src\\main\\resources\\MyDefaultValues.xml")){
